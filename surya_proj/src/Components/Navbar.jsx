        ...
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                <Link to="/" className="flex items-center">
                    <span className="self-center text-3xl text-red-700 font-semibold whitespace-nowrap dark:text-white">Kshatriya Mahratta</span>
                </Link>
                ...
                <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    ...
                    <ul className="flex flex-col pt-1 pb-1 mt-4 mr-1 ml-1 md:flex-row space-x-8 md:space-x-8 md:mt-0 md:text-sm md:font-medium font-bold">
                    <CustomLink to='/'>Home</CustomLink>
                    <CustomLink to='/clanlist'>96 Clan List</CustomLink>
                    ...
                    <CustomLink to='#'>Services</CustomLink>
                        ...
                        {/* <li>
                            <Link to="/clanlist" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">96Clan List</Link>
                        </li>
                        <li>
...
function CustomLink({ to, children, ...props }) {
    ...
    return (
        <li aria-current={isActive ? "page" : ""}>
            <Link to={to} {...props} className="block text-white bg-red-700 rounded md:bg-transparent md:text-red-500 md:p-0.5 hover:bg-gray-400 md:hover:bg-royalOrange md:border-0 md:hover:text-red-700 dark:text-white" >{children}</Link>
        </li>
    )
}